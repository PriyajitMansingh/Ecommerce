...
const HeroSlider = () => {
  ...
  return (
    <>
      ...
      >
        {/*
          ONE fixed-ratio frame for every slide. The ratio changes only by
          breakpoint (not per-slide), so the hero never jumps or resizes
          when the slide changes — every image fills the same frame via
          object-cover, cropped evenly instead of leaving letterbox bars.
        */}
        <div className="relative w-full overflow-hidden aspect-[4/5] sm:aspect-[16/9] lg:aspect-[21/8]">
          <div
