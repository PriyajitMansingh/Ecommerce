    ...
    <>
      ...
      <footer className="bg-gradient-to-b from-[#F3E4C8] to-[#EFDFC8] text-[#3d2a1a] pt-10 pb-8 px-6 md:px-16 relative overflow-hidden border-t border-[#3d2a1a]/10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 relative z-10">
          ...
          <div>
            <h4 className="text-sm font-bold mb-4 text-[#B8860B]">Quick Links</h4>
            <ul className="space-y-2 text-sm text-[#6b5940]">
              <li><a href="/" className="hover:text-[#B8860B] transition-colors">Home</a></li>
              <li><a href="/about" className="hover:text-[#B8860B] transition-colors">About Us</a></li>
              <li><a href="/products" className="hover:text-[#B8860B] transition-colors">Products</a></li>
              <li><a href="/contact" className="hover:text-[#B8860B] transition-colors">Contact</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-bold mb-4 text-[#B8860B]">Customer Care</h4>
            <ul className="space-y-2 text-sm text-[#6b5940]">
               <li><a href="/terms-of-service" className="hover:text-[#B8860B] transition-colors">TERMS OF SERVICES</a></li>
                <li><a href="/privacy-policy" className="hover:text-[#B8860B] transition-colors">Privacy Policy</a></li>
              <li><a href="/shipping-policy" className="hover:text-[#B8860B] transition-colors">Shipping Policy</a></li>
              <li><a href="/return-refund-policy" className="hover:text-[#B8860B] transition-colors">RETURN & REFUND POLICY</a></li>
              <li><a href="#" className="hover:text-[#B8860B] transition-colors">FAQs</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-bold mb-4 text-[#B8860B]">Get in Touch</h4>
            <p className="text-sm text-[#6b5940] mb-2">support@houseoftoshali.com</p>
        ...
        <div className="border-t border-[#3d2a1a]/10 mt-10 pt-6 max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-5">
            <div className="flex items-center gap-3">
              <a href="#" aria-label="Facebook" className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#3d2a1a] hover:bg-[#3d2a1a] hover:text-white transition-colors shadow-sm">
              ...
              <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#3d2a1a] hover:bg-[#3d2a1a] hover:text-white transition-colors shadow-sm">
              ...
              <a href="#" aria-label="WhatsApp" className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#3d2a1a] hover:bg-[#3d2a1a] hover:text-white transition-colors shadow-sm">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              ...
              {['UPI', 'Visa', 'Mastercard', 'RuPay', 'COD'].map((method) => (
                <span
                  key={method}
                  className="text-[11px] font-semibold text-[#3d2a1a] bg-white px-3 py-1.5 rounded-md shadow-sm"
                >
                  {method}
                </span>
              ))}
          ...
          <div className="border-t border-[#3d2a1a]/10 pt-5 flex flex-col md:flex-row items-center justify-center md:justify-between gap-2 text-xs text-[#6b5940]">
            <p>© 2026 House of Toshali. All rights reserved. | FSSAI - 12026999000089</p>
            <p>
              ...
              <a
                ...
                className="text-[#B8860B] font-semibold hover:text-[#D4AF37] hover:underline transition-colors"
              >
