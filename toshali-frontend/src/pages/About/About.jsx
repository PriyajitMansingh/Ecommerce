    ...
    <>
      ...
      <section className="relative bg-[#FBF9F2] min-h-screen pb-20 px-6 md:px-16 overflow-hidden">
        ...
        <img
          src={almondLoose}
          alt=""
          className="hidden md:block absolute top-16 left-6 w-24 rotate-[-15deg] opacity-70 pointer-events-none drop-shadow-lg"
        />
        <img
          src={cashewLoose}
          alt=""
          className="hidden md:block absolute top-40 right-8 w-24 rotate-[12deg] opacity-70 pointer-events-none drop-shadow-lg"
        />
        <img
          src={makhanaLoose}
          alt=""
          className="hidden md:block absolute bottom-24 left-10 w-20 rotate-[8deg] opacity-60 pointer-events-none drop-shadow-lg"
        />
        ...
        <div className="max-w-5xl mx-auto pt-8 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[#6b5940] text-base leading-relaxed max-w-2xl mx-auto">
              House of Toshali was born from a simple belief — that dry fruits
              deserve to be pure, natural, and handpicked with care. We work
              directly with trusted growers to bring you healthy snacks and
              delightful flavors that carry the richness of tradition and the
              promise of quality.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16">
            <div>
              <h2 className="font-serif text-2xl text-[#3d2a1a] mb-4">
                Handpicked,{" "}
                <span className="italic text-[#B8860B]">Hand-Sorted.</span>
              </h2>
              <p className="text-sm text-[#6b5940] leading-relaxed mb-4">
                Every batch that carries the House of Toshali name is sorted by
                hand, sealed for freshness, and shipped with the same care we'd
                give a gift for our own family. No shortcuts, no fillers — just
                honest, premium dry fruits.
              </p>
              <p className="text-sm text-[#6b5940] leading-relaxed">
                We're proud to be based in Odisha, and even prouder to bring a
                taste of home to households across the country.
              </p>
            </div>
            <div className="rounded-3xl overflow-hidden shadow-xl">
              <img
                src={heroBowl}
                alt="House of Toshali dry fruits bowl"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#3d2a1a]/10">
              <p className="font-serif text-3xl font-bold text-[#B8860B] mb-2">
                100%
              </p>
